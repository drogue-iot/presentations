...
It is an optional feature, built on top of the IoT connectivity layer and device registry:

* Firmware delivery
** Built-in firmware management using container registries
** External firmware providers like Eclipse Hawkbit
** Lightweight OTA protocol supported by all device endpoints
