...
* Actor based firmware for microcontrollers
* Written in Rust
...
Actor based firmware for microcontrollers, written in Rust.
...
* Aggregation of components from the Embedded Rust ecosystem
** Embassy: Async scheduler
** Ector: Actor based framework
* Hardware abstractions
** STM32, nRF, Raspberry Pi Pico
* Drivers
